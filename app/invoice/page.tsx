...
export default function InvoicePage() {
    ...
    const load = async () => {
      ...
      try {
        ...
        try {
          ...
          // kalau profile gagal, biarin ke default
        }
  ...
  const handleDownload = async () => {
    try {
      ...
      // convert payment proof ke base64 kalau ada
